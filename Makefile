...
#    Updated: 2024/10/03 13:12:42 by ytop             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	$(SRCS_DIR)minishell.c $(SRCS_DIR)heredoc.c $(COMPILER_DIR)lexer.c $(COMPILER_DIR)parser.c $(COMPILER_DIR)replace_arg.c $(EXECUTOR_DIR)executor.c $(EXECUTOR_DIR)executor_utils.c $(REDIRECT_DIR)redirect.c $(BUILTIN_DIR)cd.c $(BUILTIN_DIR)cd_utils.c $(BUILTIN_DIR)echo.c $(BUILTIN_DIR)env.c $(BUILTIN_DIR)exit.c $(BUILTIN_DIR)export.c $(BUILTIN_DIR)pwd.c $(BUILTIN_DIR)unset.c $(DOLLAR_DIR)dollar.c $(DOLLAR_DIR)dollar_utils.c $(UTIL_DIR)check_line.c $(UTIL_DIR)h_syntax.c $(UTIL_DIR)signal.c $(UTIL_DIR)split.c $(UTIL_DIR)utils.c
